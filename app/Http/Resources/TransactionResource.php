...
class TransactionResource extends JsonResource
{
    public function toArray($request): array
    {
        ...
        if ($currentStep) {
            $this->loadMissing(['requirementChecks.checker']);
        ...
        if ($this->relationLoaded('workflow') && $this->workflow?->relationLoaded('steps')) {
            $this->loadMissing(['workflow.steps.requirementDefinitions', 'workflow.steps.fieldDefinitions', 'requirementChecks.checker', 'fieldValues.fieldDefinition']);
