                    ...
                    <v-row class="mt-1">
                        <v-col cols="12" class="d-flex justify-end">
                            <v-btn
                                color="grey-darken-3"
                                rounded="0"
                                :disabled="!selectedRouteId || saving || missingRequiredLabels.length > 0"
                                :loading="saving"
                                @click="openProceed()"
                            >
                                Proceed
        ...
        <v-dialog v-model="remarksDialog" max-width="800">
            <v-card rounded="0">
                ...
                <v-card-actions class="justify-end">
                    ...
                    <v-btn color="grey-darken-3" rounded="0" :loading="saving" :disabled="!selectedRouteId" @click="executeSelected">Proceed</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
