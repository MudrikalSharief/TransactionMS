    ...
    <div>
        <v-card rounded="0" elevation="1" class="lgu-card mb-4">
            <v-card-title class="d-flex align-center pa-5">
                ...
                <div>
                    <span class="text-h6 font-weight-bold">{{ selectedTypeName || "Transaction Steps" }}</span>
            ...
            <v-card-text class="pa-4">
                ...
                <v-alert
                    ...
                    class="mb-3"
                >
                    No transaction type selected. Go back to
...
async function goStepFields(item) {
    ...
    try {
        ...
        router.push(`/admin/workflows/${activeDef.value.id}/steps/${fresh.id}/fields`);
    } catch (e) {
...
async function goStepRequirements(item) {
    ...
    try {
        ...
        await ensureDraft();
        const fresh = stepInDraft(oldSteps, item);
        router.push(`/admin/workflows/${activeDef.value.id}/steps/${fresh.id}/requirements`);
    } catch (e) {
